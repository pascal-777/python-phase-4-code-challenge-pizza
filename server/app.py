...
def create_restaurant_pizza():
    ...
    try:
        ...
        restaurant_pizza_dict["pizza"] = new_restaurant_pizza.pizza.to_dict(only=("id", "name", "ingredients"))
        restaurant_pizza_dict["restaurant"] = new_restaurant_pizza.restaurant.to_dict(only=("id", "name", "address"))
